...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{REDLANDMYSQL_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{REDLANDMYSQL_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
redlandmysql_server.pl - Catalyst Testserver

=head1 SYNOPSIS

redlandmysql_server.pl [options]
