...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{LIBRDF_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{LIBRDF_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
librdf_server.pl - Catalyst Testserver

=head1 SYNOPSIS

librdf_server.pl [options]
